...
const Timer = () => {
  ...
  return (
    <div className="w-full max-w-xs bg-[#FF7F27] rounded-lg shadow-md hover:shadow-xl transition-shadow duration-300 pt-7">
      {/* Card Content */}
      <div className="p-6">
        {/* Name */}
        <h3 className="text-2xl font-bold text-white">Salad</h3>
